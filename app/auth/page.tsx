      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
        <div className="flex flex-col items-center mb-6">
          <img src="/CAN_TTN.png" alt="CAN Thrive Together Network" className="h-14 mb-3" />
           <p className="text-xl font-bold text-blue-800">CAN Thrive Together Network</p>
           <h1  className="text-2x1 font-semibold text-yellow-500">Build together · Thrive together</h1>

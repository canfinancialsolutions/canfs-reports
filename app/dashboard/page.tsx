 ...
 * - Yellow highlight (no timestamp considered) for BOP Date & Follow-Up Date cells when they are today-or-future in Upcoming Meetings + All Records. 
 * - Upcoming Meetings: Refresh resets to default 30-day range; "Show Results" button is green when active (visible). 
        ...
        <Card title="Upcoming Meetings (Editable)"> 
          ...
          {upcomingVisible && ( 
            <ExcelTableEditable 
              ...
              stickyLeftCount={1} 
              // NEW: mark new columns as non-editable in Upcoming + view-only popups for specific keys 
